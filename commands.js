...
const fs = require('fs');
const ownerNumber = ['201288455338']
const prefix = '.'
 ...
 //_______________________________________________________________________________________________________________________________________________________   //      
        ...
        case 'ملصق' :
         ...
         await conn.sendMessage(from, { delete: cstic.key })
	       ...
	       v.reply('أين هي الصورة او الفيديو الذي تريد ان تحوله لملصق يا بني')
        }
              break 
...
await conn.sendMessage(from , { text: 'error' }, { quoted: mek } )  
 ...
 //_______________________________________________________________________________________________________________________________________________________   //		      
    ...
    const listMessage = {
      text: " \n\n name : " + q + '\n\n ',
      footer: config.FOOTER,
      title: '🔱BOT Al SoLtAn🔱 تحميل التطبيقات',
...
╰────────────────────╯
  ...
  // _ _ _ _ _ _ _ _ __  _ _ _ _ _ _  __  _ _ _ __ _  __ _  _ _ _ _ __ _ _  __  __ _  _ __  _ __ _ _ _  _ __ _  _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ __  __ _  __ _ _ _ _   //   		      
		...
		const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + `FN:` + ' youssef_alsoltan ' + `\n` // full name
            + 'TEL;type=CELL;type=VOICE;waid=' + '201288455338' + ':+' + '201288455338' + '\n' // WhatsApp ID + phone number
            + 'END:VCARD'
 await conn.sendMessage(from,{ contacts: { displayName: 'youssef_alsoltan' , contacts: [{ vcard }]  }} , { quoted: mek })      
		      break 
 //_______________________________________________________________________________________________________________________________________________________   //		      
