...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'https://wa.me/+201288455338 ' : process.env.URL_1LINK,
    URL_2NAME: process.env.URL_2NAME === undefined ? '✨قروبي✨' : process.env.URL_2NAME,
    URL_2LINK: process.env.URL_2LINK === undefined ? 'https://chat.whatsapp.com/FiRwXZoBuSyLlUZBtNAgx8' : process.env.URL_2LINK,
    FOOTER: process.env.FOOTER === undefined ? 'AlsoltanBot-MD  https://wa.me/+201288455338  تابعني على الواتساب ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? '🔱 YoUsSeF Al SoLtAn 🔱 𝙱𝙾𝚃 𝙼𝙳 https://chat.whatsapp.com/FiRwXZoBuSyLlUZBtNAgx8 ادخل نطقطق' : process.env.CAPTION,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/d97881d3cfbd65faa278f.jpg' : process.env.ALIVE_LOGO,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? '🔱 YoUsSeF Al SoLtAn 🔱' : process.env.STIC_WM,
};
